...
*Defined in [types.ts:55](https://github.com/polkadot-js/ui/blob/64cae00/packages/ui-keyring/src/types.ts#L55)*
...
*Defined in [types.ts:57](https://github.com/polkadot-js/ui/blob/64cae00/packages/ui-keyring/src/types.ts#L57)*