...
*Defined in [types.ts:55](https://github.com/polkadot-js/ui/blob/d0ef98b/packages/ui-keyring/src/types.ts#L55)*
...
*Defined in [types.ts:57](https://github.com/polkadot-js/ui/blob/d0ef98b/packages/ui-keyring/src/types.ts#L57)*