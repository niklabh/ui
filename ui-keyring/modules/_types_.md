...
*Defined in [types.ts:54](https://github.com/polkadot-js/ui/blob/85a8a3a/packages/ui-keyring/src/types.ts#L54)*
...
*Defined in [types.ts:56](https://github.com/polkadot-js/ui/blob/85a8a3a/packages/ui-keyring/src/types.ts#L56)*