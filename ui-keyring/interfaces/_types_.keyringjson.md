...
*Defined in [types.ts:45](https://github.com/polkadot-js/ui/blob/64cae00/packages/ui-keyring/src/types.ts#L45)*
...
*Defined in [types.ts:46](https://github.com/polkadot-js/ui/blob/64cae00/packages/ui-keyring/src/types.ts#L46)*